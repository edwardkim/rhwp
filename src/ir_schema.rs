...
//!
//! `mydocs/tech/bindings_foundation.md` §1 이 고정한 M18 착수 조건이다. 외부
//! 바인딩(파이썬·Node·C#)이 코드 생성을 하려면 **IR 의 모양이 기계가 읽을 수 있는
//! 형태**로 나와야 한다. capabilities 가 명령 표면의 자기서술이라면, 이 스키마는
//! **문서 모델의 자기서술**이다.
//!
//! ## 왜 손으로 쓰는가
//!
