...
pub enum ConvertError {
    ...
    PlayError { source: crate::wmf::converter::PlayError },
}
...
impl From<crate::wmf::converter::PlayError> for ConvertError {
    fn from(source: crate::wmf::converter::PlayError) -> Self {
