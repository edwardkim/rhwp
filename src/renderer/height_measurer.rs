...
impl HeightMeasurer {
    ...
    fn measure_table_impl(
        ...
        // [Issue #1835] 내용이 저장 높이를 크게 초과하는 TAC 표는 비례 축소하지
        ...
        // 1/1.8 로 눌려 셀 텍스트가 겹치던 결함. 경미한 초과는 종전대로
        // 속성 높이 유지(#672 한컴 정합 — 의도적 압축 존중). 종전 상한 1.5 는
        // 아래 TAC_SHRINK_MAX_RATIO=1.35 로 흡수된다(1.5 초과는 1.35 초과이므로
        // 동일하게 확장).
