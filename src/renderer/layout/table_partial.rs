...
struct LayoutPartialTableInput<'a> {
    ...
    enclosing_cell_ctx: Option<&'a CellContext>,
    clamp_header_negative_para_offset: bool,
    probe: Option<&'a PartialTableCellProbe>,
}

struct LayoutPartialTableResolvedInput<'a> {
    tree: &'a mut PageLayoutContext,
    col_node: &'a mut RenderNode,
    outer_table: &'a crate::model::table::Table,
    host: PartialTableHostContext<'a>,
    section_index: usize,
    styles: &'a ResolvedStyleSet,
    outline_numbering_id: u16,
    col_area: &'a LayoutRect,
...
struct LayoutPartialTableCellsInput<'a> {
    tree: &'a mut PageLayoutContext,
...
impl LayoutEngine {
    ...
    fn layout_partial_table_cells(
        ...
        crate::hot_call!(
            Self::layout_partial_table_cells_hot_impl,
            self,
            LayoutPartialTableCellsInput {
                tree,
                table_node,
                table,
                para_index,
    ...
    fn layout_partial_table_cells_hot_impl(&self, input: LayoutPartialTableCellsInput<'_>) {
        let LayoutPartialTableCellsInput {
            tree,
            table_node,
            table,
            para_index,
    ...
    pub(crate) fn layout_partial_table(
        ...
        crate::hot_call!(
            Self::layout_partial_table_hot_impl,
            self,
            LayoutPartialTableInput {
                tree,
                col_node,
                paragraphs,
                para_index,
    ...
    fn layout_partial_table_hot_impl(&self, input: LayoutPartialTableInput<'_>) -> f64 {
        let LayoutPartialTableInput {
            tree,
            col_node,
            paragraphs,
            para_index,
    ...
    fn layout_partial_table_resolved(
        ...
        crate::hot_call!(
            Self::layout_partial_table_resolved_hot_impl,
            self,
            LayoutPartialTableResolvedInput {
                tree,
                col_node,
                outer_table,
                host,
    ...
    fn layout_partial_table_resolved_hot_impl(
        &self,
        input: LayoutPartialTableResolvedInput<'_>,
    ) -> f64 {
        let LayoutPartialTableResolvedInput {
            tree,
            col_node,
            outer_table,
            host,
