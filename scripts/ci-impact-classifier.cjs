...
// Chrome uses the same trusted sparse checkout as the policy controller.
// Keep this independent axis here so older controller workflows need no new dependency file.
