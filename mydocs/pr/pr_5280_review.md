...
# PR #5280 검토 — gym: tutorial + PARK 입문 문서·링크·프로파일 계약
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#5280](https://github.com/edwardkim/rhwp/pull/5280) / @kevin9327 |
| 원 head | `572e3c1513baa31ab19dc8664ee2e4986526b008` |
| 기준 devel | `0bc05ef81107ac61ec38d622f71b44a44d1b4821` |
| 검토 브랜치 | `review/kevin9327-5212-5314-20260818` |
| 기능 source → 누적 적용 | `572e3c1` → `ae51afd4` |
...
gym tutorial·PARK·프로파일 문서와 CI tutorial 검사를 정비한다. CI workflow 영향 검증, CodeQL workflow 검증, tutorial Python 검증을 모두 통과했다.
