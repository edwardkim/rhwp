...
# PR #5268 검토 — gym: discriminate 음성 대조(sentinel/copy/garbage) 고도화
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#5268](https://github.com/edwardkim/rhwp/pull/5268) / @kevin9327 |
| 원 head | `c5470cb8f7a48ebf3e7bf842b120076cc5867369` |
| 기준 devel | `0bc05ef81107ac61ec38d622f71b44a44d1b4821` |
| 검토 브랜치 | `review/kevin9327-5212-5314-20260818` |
| 기능 source → 누적 적용 | `c5470cb` → `79a0173a` |
...
discriminate의 sentinel·복사본·garbage 음성 대조를 고도화한다. 예상 실패를 정상 판정과 분리하는 Python 계약을 확인했다.
