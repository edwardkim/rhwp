...
검증 head `471db3f06` (PR #7360 위). 정본은
...
| --- | --- | ---: | ---: | ---: | ---: |
| 16 | 글줄 | 989.81 | **975.15** | 977.07 | 12.74 → **1.92** |
| 17 | 글줄 | 992.76 | **978.09** | 979.95 | 12.81 → **1.86** |
| 18 | 중첩 표 atom | 1005.92 | **969.12** | 970.99 | 34.93 → **1.87** |
| 19 | 끝 조각(불변) | 984.07 | 984.07 | 986.03 | **1.96** |

네 쪽의 잔차가 같은 계통이다. 18쪽의 중첩 표 자체(871.97 .. 964.41)는 정본
(872.92 .. 965.39)과 0.9px 안으로 불변이다.
