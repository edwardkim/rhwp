...
# PR #5303 검토 — feat(agent): 출처 표지 소비 스킬 고도화
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#5303](https://github.com/edwardkim/rhwp/pull/5303) / @kevin9327 |
| 원 head | `9b1feae7203d2a02da4ad6032b07216f84dd2e8e` |
| 기준 devel | `0bc05ef81107ac61ec38d622f71b44a44d1b4821` |
| 검토 브랜치 | `review/kevin9327-5212-5314-20260818` |
| 기능 source → 누적 적용 | `9b1feae` → `7142f2ea` |
...
출처 표지 소비 skill과 provenance contract를 고도화한다. capabilities registry 충돌에서는 기존 CAP-5293과 추가 CAP-5295를 모두 보존했고 suite 021이 통과했다.
