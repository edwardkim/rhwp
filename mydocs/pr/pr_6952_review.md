...
**최종 판정: 메인터너 보정 후 수용 가능.** 원 head `4529c2a0c0104a2783b44a5b798a7badce628042`를 그대로 승인하는 판정이 아니라, #6940의 명시적 빈 접미를 보존하는 충돌 해소와 메인터너 테스트 입력 보정을 포함한 통합 커밋 `80ceb5ce1149106e389f7325a48545bb20a14031`에 대한 판정이다.
...
`80ceb5ce1149106e389f7325a48545bb20a14031`에 고정했다. 작업지시자 시각 승인·최종 통합 CI 전이므로
