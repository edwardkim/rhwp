...
# PR #5239 검토 — gym: competitive_bench 순수 함수·시험 강화
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#5239](https://github.com/edwardkim/rhwp/pull/5239) / @kevin9327 |
| 원 head | `aa9734760fc5f5fc674999999920ded7426af55e` |
| 기준 devel | `0bc05ef81107ac61ec38d622f71b44a44d1b4821` |
| 검토 브랜치 | `review/kevin9327-5212-5314-20260818` |
| 기능 source → 누적 적용 | `e47f35a` → `3a5556c0`<br>`aa97347` → `c07fa67c` |
...
competitive_bench의 순수 함수와 경계 시험을 강화한다. 변경 Python 검증군 전체에서 benchmark 계약을 확인했다.
