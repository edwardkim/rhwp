...
| Native Visual Sweep | 26/27/67/68/69/70/94/108쪽 영향 검증은 각각 **94.19/91.85/99.99/96.50/99.94/100.00/99.57/99.84%**. 앞선 head의 전체 140쪽은 rhwp/PDF 모두 140쪽, `re_review_required`: 1쪽 88.11%, 40쪽 60.17%, 51쪽 66.99%, 57쪽 88.08%, 61쪽 63.30%, 82쪽 75.40%, 90쪽 61.83%, 93쪽 75.61%, 105쪽 77.50%. 후속 39/40/41쪽 **99.09/99.998/99.99%**, 50/51/52쪽 **99.95/100/100%**, 56/57/58쪽 **99.61/100/99.93%**, 60/61/62쪽 **100/99.95/99.55%**, 81/82/83쪽 **99.44/99.88/97.65%**, 89/90/91쪽 **99.96/100/98.13%**. 90쪽 보정 뒤 전체 140쪽 sweep은 양쪽 모두 140쪽, `re_review_required`: 1쪽 88.11%, 80쪽 89.03%, 93쪽 75.61%, 105쪽 77.50%. 이후 79/80쪽은 **99.94/99.98%**, 93쪽은 **99.42%**. 60~62·78~83·89~94쪽 15개 선택 페이지 모두 국소 gate 통과. 2·4·10·138쪽은 양쪽 모두 빈 페이지라 지표 없음·내용 픽셀 100% 일치. Git 제외 `output/pr-review/planet6897-7406-20260925/visual/p93-picture-bottom-final/summary.json` 참조; 새 head 전체 sweep 필요 |
