...
# PR #5286 검토 — feat(gym): certify/report 채점 산출 예외·문서·시험 강화 (#5275)
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#5286](https://github.com/edwardkim/rhwp/pull/5286) / @kevin9327 |
| 원 head | `c885c3e9d88fde5375ca5c02f8fd6de166a8f406` |
| 기준 devel | `0bc05ef81107ac61ec38d622f71b44a44d1b4821` |
| 검토 브랜치 | `review/kevin9327-5212-5314-20260818` |
| 기능 source → 누적 적용 | `c885c3e` → `34fc9d18` |
...
certify/report의 산출 예외·문서·시험을 강화한다. 검증 결과와 report 표현을 분리하는 Python 회귀가 통합 후보에서 통과했다.
