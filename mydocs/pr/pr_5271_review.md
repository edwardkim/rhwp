...
# PR #5271 검토 — docs: PR 전에 cargo fmt --all -- --check를 필수 관문으로 고정한다
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#5271](https://github.com/edwardkim/rhwp/pull/5271) / @kevin9327 |
| 원 head | `6555f1bd622c16edbe74c04a64ed184a58052add` |
| 기준 devel | `0bc05ef81107ac61ec38d622f71b44a44d1b4821` |
| 검토 브랜치 | `review/kevin9327-5212-5314-20260818` |
| 기능 source → 누적 적용 | `6555f1b` → `6497bc29` |
...
PR 전 Rust formatting gate를 기여 절차에 명시한다. 통합 후보에서 cargo fmt check를 실제로 통과시켜 문서가 가리키는 관문을 검증했다.
