...
# PR #5269 검토 — gym: trajectory 예외 경로·문서·시험 강화
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#5269](https://github.com/edwardkim/rhwp/pull/5269) / @kevin9327 |
| 원 head | `31d37a002b1d0bb04ddd0eb7416a571e128f3802` |
| 기준 devel | `0bc05ef81107ac61ec38d622f71b44a44d1b4821` |
| 검토 브랜치 | `review/kevin9327-5212-5314-20260818` |
| 기능 source → 누적 적용 | `31d37a0` → `a71f7cf7` |
...
trajectory의 예외 경로·문서·시험을 보강한다. 여정의 실패 경계가 schema와 테스트에서 고정됨을 확인했다.
