...
# PR #5290 검토 — gym: profiles 프로파일 계약·문서·시험 고도화
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#5290](https://github.com/edwardkim/rhwp/pull/5290) / @kevin9327 |
| 원 head | `b41f99fa6d63f8ce4696301a12c3f1f031133aa9` |
| 기준 devel | `0bc05ef81107ac61ec38d622f71b44a44d1b4821` |
| 검토 브랜치 | `review/kevin9327-5212-5314-20260818` |
| 기능 source → 누적 적용 | `b41f99f` → `117e3479` |
...
gym profile 선택 계약과 문서·시험을 고도화한다. 새 pack 통합 과정에서 profile 문서 pack 언급 누락을 보정해 스냅샷 검사까지 통과했다.
