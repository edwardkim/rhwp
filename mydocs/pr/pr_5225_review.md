...
# PR #5225 검토 — gym: security pack SE10–SE13 배포 전 스윕 과제 추가
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#5225](https://github.com/edwardkim/rhwp/pull/5225) / @kevin9327 |
| 원 head | `37fedd4a13be69db7c08e542162fe4b1e20e3631` |
| 기준 devel | `0bc05ef81107ac61ec38d622f71b44a44d1b4821` |
| 검토 브랜치 | `review/kevin9327-5212-5314-20260818` |
| 기능 source → 누적 적용 | `9512ea9` → `5c7c4d32`<br>`37fedd4` → `12467e43` |
...
보안 pack에 배포 전 스윕 과제를 추가한다. schema·audit·pack Python 회귀에서 기준풀이와 판정 계약을 확인했다.
