...
[개별 review](archives/pr_7221_review.md)의 최종 판정은 **승인(보정된 변경 범위)**이다.
...
3. 완료: 첫 조각의 저장 원점·수용 예약·실제 배치가 같은 결과를 소비하도록 보정했다. 최종 전체 회귀·Skia·lint 및 Native/fresh WASM 증거를 review에 기록했다.
