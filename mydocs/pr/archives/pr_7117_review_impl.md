...
# PR #7117 체리픽·검증·후속 계획

[개별 review](pr_7117_review.md)의 판정은 **승인**다. 통합 번호를 미리 만들지 않았으며
...
| 원 SHA | 로컬 SHA | 제목 |
| --- | --- | --- |
| `fa368c5f0143de525edb3db7796cc36d9217f8a0` | `0427e01a625270218d2c2fd501315f3b424ac86f` | 수정: 표 칸 안 정렬이 꼬리 공백을 폭에 세지 않는다 (#7081) |
| `ce713ac230caa936c5c831072e8de6ea06fac9e2` | `ecd36ea1522874871b5df5edeb8a871501c2a44a` | 증적(#7081): 칸 안 꼬리 공백 정렬 — 수정 전/후/한/글 2020 정본 대조 이미지 |

기준 `93ffc3dd59c120bd54df4c2ac6d1ddbe630f8a2d` 위에서 PR 순서 7094 → 7100 → 7104 → 7111 → 7112 → 7113 → 7115 →
7116 → 7117 → 7120 → 7131 → 7132로 누적했다. 이 PR의 마지막 local SHA는 `ecd36ea1522874871b5df5edeb8a871501c2a44a`다.
...
- [개별 review](pr_7117_review.md)의 최신 절이 이전 조사 단계·SHA보다 우선한다. 원래 조사·검증 이력은 보존한다.
