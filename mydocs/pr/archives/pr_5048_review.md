...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5048](https://github.com/edwardkim/rhwp/pull/5048) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `05ccca55670a` |
| 원 기능 제목 | feat(cli): edit insert-header-footer-text — 머리말/꼬리말 텍스트 삽입 |
| 통합 commit | `2da63ce73` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 3 / 25 (지정된 오래된 순서) |
