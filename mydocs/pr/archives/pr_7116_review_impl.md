...
# PR #7116 체리픽·검증·후속 계획

[개별 review](pr_7116_review.md)의 판정은 **승인**다. 통합 번호를 미리 만들지 않았으며
...
| 원 SHA | 로컬 SHA | 제목 |
| --- | --- | --- |
| `8022b13aeba8f185139982abe2d57ee828abab36` | `58df92fd0996e7ed30e0e433b156abdf1b517493` | 수정(core): OLE 개체 편집 거부에 이유와 대안을 담는다 (#7105 증상 ②) |

기준 `93ffc3dd59c120bd54df4c2ac6d1ddbe630f8a2d` 위에서 PR 순서 7094 → 7100 → 7104 → 7111 → 7112 → 7113 → 7115 →
7116 → 7117 → 7120 → 7131 → 7132로 누적했다. 이 PR의 마지막 local SHA는 `58df92fd0996e7ed30e0e433b156abdf1b517493`다.
...
ShapeOle와 native Equation은 다른 control이다. 속성 조회·설정·수식 삭제의 오류에서 OLE 미지원 이유와 가능한 일반 개체 삭제 경로를 알리고, native Equation·다른 control의 기존 의미는 유지한다.
