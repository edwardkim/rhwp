# PR #5336 검토 - agent: 표면 플레이북(capabilities·3층 계약) 스킬 신설

- PR: https://github.com/edwardkim/rhwp/pull/5336
- 작성자: `kevin9327`
- base: `devel`
- 원 head: `ee019bacbd6b911b4604ea603d6c25e0f701ef29`
- 원본 적용 SHA: `ee019ba`
...
- capabilities 기반 3층 표면 플레이북과 계약 테스트를 통합했다.
- 체리픽은 최신 `upstream/devel@0bc05ef81` 위에서 원 작성자 커밋 계보를 보존하는 `-x` 방식으로 누적했다.

## 메인터너 보정

- 계약 테스트를 `tests/cases/`로 이동했다. 지식지도 스킬이 이 실재 peer를 참조하도록 계약도 동기화했다 (`04d1a94b8`, `c9f88fd86`).
