...
# PR #7111 체리픽·검증·후속 계획

[개별 review](pr_7111_review.md)의 판정은 **메인터너 보정 후 수용 가능**다. 통합 번호를 미리 만들지 않았으며
...
| 원 SHA | 로컬 SHA | 제목 |
| --- | --- | --- |
| `effdf7cd3f8b781cbc00affc145d3189e509dc0a` | `bdee95748cb8dd43e25a692119a37434159c2bf6` | 수정(renderer): 믿을 수 있는 글꼴 표에서는 가운뎃점을 적힌 폭대로 잰다 (#7092) |
| `91e94a7a8a085131fabcaf8e924a3075a79eea05` | `7a58f41a98dd5f6482ae26723ab809dcde7575c8` | 문서(report): #7092 가운뎃점 전진폭 수정 전/후/정본 시각 증적 |
| `cd772e0bd5ae9c7032085f4a300267da86341933` | `b4c4b717bee9534c20cbebfcdd2ef02f8072b9d3` | 수정(renderer): 메트릭 신뢰 근거를 문서 선언에서 실측 검증 face 로 옮긴다 (#7092) |

기준 `93ffc3dd59c120bd54df4c2ac6d1ddbe630f8a2d` 위에서 PR 순서 7094 → 7100 → 7104 → 7111 → 7112 → 7113 → 7115 →
7116 → 7117 → 7120 → 7131 → 7132로 누적했다. 이 PR의 마지막 local SHA는 `b4c4b717bee9534c20cbebfcdd2ef02f8072b9d3`다.
...
C1 [해결]: 최신 devel #7084의 supplemental_metrics와 충돌했다. resolved_to_text_style에서 supplemental_metrics 복제와 font_metric_trusted 전달을 모두 보존해 로컬 bdee95748로 적용했고 #7084 계약도 focused 검증에 포함했다. 원 fork head 자체는 GitHub DIRTY다.
...
- [개별 review](pr_7111_review.md)의 최신 절이 이전 조사 단계·SHA보다 우선한다. 원래 조사·검증 이력은 보존한다.
