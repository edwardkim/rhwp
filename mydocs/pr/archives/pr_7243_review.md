...
후보 26 당시에는 PDF의 글꼴·일부 위치 차이와 #7242 원 합성 입력 보류가 남아 있었다.
#7242는 이후 `c877f6e48`·`bb401f0a7`로 해소되어 승인됐으며, 현재 #7243의 보류 조건은
문서 상단을 따른다. 후보 26의 결과만으로 통합 PR 전체 승인을 뜻하지 않는다. 원격 push·GitHub comment·merge는 이 회차에서 수행하지 않았다.
