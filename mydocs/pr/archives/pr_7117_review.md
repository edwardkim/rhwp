...
# PR #7117 — 셀 안 Center·Right 정렬의 말미 공백 제외 검토
...
원 PR head `ce713ac230caa936c5c831072e8de6ea06fac9e2` → 현재 통합 이력의 cherry-pick `ec734a6bf5073409c926e2838da17fee82229fd0`. 원 저자와 `-x` 출처를 보존했다.
...
| 항목 | 확인값 |
| --- | --- |
| 원 PR | [#7117](https://github.com/edwardkim/rhwp/pull/7117) — 수정: 표 칸 안 정렬이 꼬리 공백을 폭에 세지 않는다 (#7081) |
| 작성자 / reviewer | planet6897 / jangster77 사전 지정 |
| 원 base / 규모 | `devel`; 8 files, +247/-69 |
| source head | `ce713ac230caa936c5c831072e8de6ea06fac9e2` |
...
| 관련 이슈 | [#7081](https://github.com/edwardkim/rhwp/issues/7081); 부분 반영 범위만 판단, 이번 작업에서 종료하지 않음 |
...
| --- | --- | --- |
| `fa368c5f0143de525edb3db7796cc36d9217f8a0` | `0427e01a625270218d2c2fd501315f3b424ac86f` | 충돌 없음; -x·저자 유지 |
| `ce713ac230caa936c5c831072e8de6ea06fac9e2` | `ecd36ea1522874871b5df5edeb8a871501c2a44a` | 충돌 없음; -x·저자 유지 |

### 실제 변경 경로

- `mydocs/report/cell-trailing-ws-alignment-7081/README.md` (+27/-0)
- `mydocs/report/cell-trailing-ws-alignment-7081/cancel-request-form-center-signature-before-after-oracle.png` (+0/-0)
- `mydocs/report/cell-trailing-ws-alignment-7081/objection-form-right-signature-before-after-oracle.png` (+0/-0)
- `src/renderer/layout/paragraph_layout.rs` (+23/-5)
- `tests/cases/issue_7081_cell_trailing_space_alignment.rs` (+133/-0)
- `tests/golden_svg/form-002/page-0.svg` (+50/-50)
- `tests/golden_svg/issue-677/bokhakwonseo-page1.svg` (+4/-4)
- `tests/golden_svg/table-text/page-0.svg` (+10/-10)

## 조판 원칙과 원인 계층

순수 텍스트 줄의 꼬리 공백은 셀 안에서도 가운데/오른쪽 정렬 폭에서 제외한다. TAC 객체가 우단 앵커를 소유하는 줄은 기존 공백 포함 규칙을 유지한다. 밑줄과 visible ending 구분을 보존한다.

주요 검토 위치: [src/renderer/layout/paragraph_layout.rs](../../../src/renderer/layout/paragraph_layout.rs).

| 공통 항목 | 판정 | 근거·제한 |
| --- | --- | --- |
| 구현 근거와 일반성 | 충족 | 순수 텍스트 줄의 꼬리 공백은 셀 안에서도 가운데/오른쪽 정렬 폭에서 제외한다. TAC 객체가 우단 앵커를 소유하는 줄은 기존 공백 포함 규칙을 유지한다. 밑줄과 visible ending 구분을 보존한다. |
...
table-text 2024 두 앵커가 x=207.8/513.4→210.8/516.4px로 이동해 한컴 210.72/516.16에 접근했고 나머지 두 앵커는 불변이다. 복학원서 Name 423.4→426.9, PDF 426.65px. 새 통합 head의 실제 수치는 이의신청서 207.1→309.6(PDF304.64), 취소신청서 187.9→203.3(PDF202.93), VAT 7쪽 229.5→339.5(PDF339.52)다.

이번 검토 범위에서 새 실행 회귀 또는 수용을 막는 코드 문제를 발견하지 않았다. 아래 잔여·미검증 범위는 승인 대상에 포함하지 않는다.

**잔여·미검증:** 원 PR 단독 기록의 307.1/200.9를 최신 통합 결과로 재사용하지 않았다. 이의신청서 약 +5px와 form-002 약 -4px 잔여가 있으며 문서 전체의 글꼴·글자폭 일치로 선언하지 않는다. 원본·PDF를 korea_downloads 밖 Git에 보존했다.
...
- table-text-p001: [한컴 / 변경 전 / 통합 비교](../assets/pr7117_table-text-p001_3way.png), [한컴·통합 overlay](../assets/pr7117_table-text-p001_ovl.png)
- bokhak-p001: [한컴 / 변경 전 / 통합 비교](../assets/pr7117_bokhak-p001_3way.png), [한컴·통합 overlay](../assets/pr7117_bokhak-p001_ovl.png)
- objection-form-p001: [한컴 / 변경 전 / 통합 비교](../assets/pr7117_objection-form-p001_3way.png), [한컴·통합 overlay](../assets/pr7117_objection-form-p001_ovl.png)
- cancel-request-p001: [한컴 / 변경 전 / 통합 비교](../assets/pr7117_cancel-request-p001_3way.png), [한컴·통합 overlay](../assets/pr7117_cancel-request-p001_ovl.png)
- vat-bank-p007: [한컴 / 변경 전 / 통합 비교](../assets/pr7117_vat-bank-p007_3way.png), [한컴·통합 overlay](../assets/pr7117_vat-bank-p007_ovl.png)
...
| [samples/hwpx/table-text.hwpx](../../../samples/hwpx/table-text.hwpx) | 한컴 입력; table-text | `c31c5267c4c686cefd5b5df1056e0e4bc64d13c8c67dcdaeb2933a28e9df6c8f` |
| [pdf/hwpx/table-text-2022.pdf](../../../pdf/hwpx/table-text-2022.pdf) | 독립 한컴 PDF 1쪽; 직접 sweep 1쪽 | `675b39f7a7c5b6ef6e4c6afadee08ee7c043862d978696233dd944c77e7ab46a` |
| [samples/복학원서.hwp](../../../samples/복학원서.hwp) | 한컴 입력; bokhak | `da81b4010331bcac290f900c7cf224c97ee8355399614725ce46c197ff1a22a4` |
| [pdf/복학원서-hwp-2020.pdf](../../../pdf/복학원서-hwp-2020.pdf) | 독립 한컴 PDF 1쪽; 직접 sweep 1쪽 | `ed28f2655a27d22acdbf214520115522ad3124a3643d18fba58beebba1935068` |
| [tests/fixtures/issue_7081/3030681-objection-form.hwp](../../../tests/fixtures/issue_7081/3030681-objection-form.hwp) | 한컴 입력; objection-form | `0280931ac5c35f5335715b226670a72cbafc81d47b1ea1b1aa31025a57ebd4ec` |
| [pdf/pr-planet6897-20260914/objection-form-hwp-2020.pdf](../../../pdf/pr-planet6897-20260914/objection-form-hwp-2020.pdf) | 독립 한컴 PDF 1쪽; 직접 sweep 1쪽 | `4cf7ccf29b4154bfa77323626791772afc29770fb3e3ee16825162d781c32cd2` |
| [tests/fixtures/issue_7081/3079571-cancel-request-form.hwp](../../../tests/fixtures/issue_7081/3079571-cancel-request-form.hwp) | 한컴 입력; cancel-request | `9983d1fad02569a4ed2fc0b562331f4ad7ae437268e8bb218d6b593770da472a` |
| [pdf/pr-planet6897-20260914/cancel-request-hwp-2020.pdf](../../../pdf/pr-planet6897-20260914/cancel-request-hwp-2020.pdf) | 독립 한컴 PDF 1쪽; 직접 sweep 1쪽 | `2807271033a1572196836d3a16c4f4bc8e6e647c71ae373b770f9e962207c156` |
| [tests/fixtures/issue_7081/1319800-vat-bank-designation.hwp](../../../tests/fixtures/issue_7081/1319800-vat-bank-designation.hwp) | 한컴 입력; vat-bank | `a489ade7adfbbfb2407708d73238076dc5a109e1078bfcc2b52a1accf1b73773` |
| [pdf/pr-planet6897-20260914/vat-bank-hwp-2020.pdf](../../../pdf/pr-planet6897-20260914/vat-bank-hwp-2020.pdf) | 독립 한컴 PDF 12쪽; 직접 sweep 2,7쪽 | `4e8305da812aa2a1ee471103fb001e608501736ccf5d61372e31fb007751ebce` |
...
[적용·후속 단계](pr_7117_review_impl.md)
...
| --- | --- | --- | --- |
| table-text 1쪽 | 0 (없음) | 98.98067% | 69.00280% |
| objection-form 1쪽 | 0 (없음) | 96.53187% | 47.74763% |
| cancel-request 1쪽 | 0 (없음) | 95.92334% | 13.22511% |
| bokhak 1쪽 | 2 (line_order_overlap, column_line_band_drift) | 92.73862% | 46.26671% |
| vat-bank 7쪽 | 0 (없음) | 95.33613% | 36.53415% |
...
대표 asset은 [비교 PNG](../assets/pr7117_table-text-p001_3way.png)이며, 실제 merge 뒤
`https://raw.githubusercontent.com/edwardkim/rhwp/<merge-commit-sha>/mydocs/pr/assets/pr7117_table-text-p001_3way.png`로 고정한다.
