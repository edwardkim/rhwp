# PR #5379 검토 - feat(layout-anomaly): text-overlap 텍스트 런 bbox 교차 판정

- PR: https://github.com/edwardkim/rhwp/pull/5379
- 작성자: `kevin9327`
- base: `devel`
- 원 head: `9db425cdc54a3f67c24cc17a1e4fdfe78675826c`
- 원본 적용 SHA: `9db425c`
...
- layout-anomaly의 text-overlap 신호·JSON 계약·회귀 fixture를 통합했다.
- 체리픽은 최신 `upstream/devel@0bc05ef81` 위에서 원 작성자 커밋 계보를 보존하는 `-x` 방식으로 누적했다.

## 메인터너 보정

- 집중 text-overlap 회귀와 전체 회귀를 통과했다. 진단 결과 확장으로 렌더 픽셀 출력 변경을 주장하지 않는다.
