# PR #5349 검토 - feat(agent): 현장 FDE 대응 스킬을 접수·트리아지 계약으로 고도화한다 (#5333)

- PR: https://github.com/edwardkim/rhwp/pull/5349
- 작성자: `kevin9327`
- base: `devel`
- 원 head: `0272ad1c231bbea7bac052240f5b47a2a13f1358`
- 원본 적용 SHA: `0272ad1`
...
- FDE 접수·triage·정지 규칙·인계 계약을 통합했다.
- 체리픽은 최신 `upstream/devel@0bc05ef81` 위에서 원 작성자 커밋 계보를 보존하는 `-x` 방식으로 누적했다.

## 메인터너 보정

- 계약 테스트를 `tests/cases/`로 이동하고 실제 `rhwp capabilities --json` 관측 진입점을 명시했다 (`04d1a94b8`, `cd9f557ac`).
