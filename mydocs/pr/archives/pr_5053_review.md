...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5053](https://github.com/edwardkim/rhwp/pull/5053) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `c63c6cb3b8fb` |
| 원 기능 제목 | feat(cli): edit set-hf-picture — 머리말/꼬리말 그림 속성 |
| 통합 commit | `19cf5a48e` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 6 / 25 (지정된 오래된 순서) |
