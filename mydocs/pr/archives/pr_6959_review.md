# PR #6959 검토: 꼬리말 선과 경로의 좌표 이동

## 판정: 승인

검토일: 2026-09-10. 검토자: jangster77.

꼬리말 이동 시 Line/Path의 실제 그리기 좌표도 함께 이동하는 변경을 검토했다. 관련 집중 테스트 2개가 통과했고, 기준 PDF 12쪽과 대조하여 꼬리말 선이 본문 아래에 유지되는 것을 확인했다.

## 검토 기준과 출처

- 원 PR: https://github.com/edwardkim/rhwp/pull/6959
- 검토한 원 PR head: `9ed3a34b90bddc1b6fd9f0327c546b9aa9b03b5b`.
...
| 원본 commit | 적용 commit |
| --- | --- |
| `a8fa8f15c2c946f3b13f9a55158be5e5fb274bf7` | `a9e85652d74b1019b7ec05d5170729d069cae0e8` |
| `19dda565c40549901dd69b6d51b7c234fe0cbec7` | `9475dd5c10eb5f8b9b132fc6e977b0215932072e` |
| `e5d8a99429062b3b452d2583dc3f478abf882af4` | `c89bd0a5a7f2dc66dc0094f2df79eb0fc3830183` |
| `9ed3a34b90bddc1b6fd9f0327c546b9aa9b03b5b` | `6334bdbda1b96cf4fd0e3b52b19d21587df8b7a3` |
...
![PR #6959 검토 증적 pr6959-p012.png](../assets/pr_6959_6983_planet6897_20260910/pr6959-p012.png)

기준 PDF: [148733091-briefing-stenographic-record-2020.pdf](../../../pdf/148733091-briefing-stenographic-record-2020.pdf). 기존의 신뢰 가능한 한컴 PDF는 재사용하고, 필요한 최종 기준 PDF만 보관했다.

한컴 기준과 약 4px의 위치 차이 및 글꼴·줄바꿈 차이는 남는다. 문서 전체의 픽셀 일치를 승인한 것은 아니다.
...
- 원 PR #6959에 체리픽 통합 수용 사실, 실제 통합 PR 번호와 merge SHA, 원 변경과 메인터너 보정의 차이를 기록한다. 원 PR을 직접 merge했다고 표현하지 않는다.
- Visual Sweep 및 검증 기록의 정본 direct link는 `https://github.com/edwardkim/rhwp/blob/<merge-commit-sha>/mydocs/pr/archives/pr_6959_review.md`로 고정한다.
- 실제 증적 범위: 12쪽 1개 페이지를 대조했다. pixel match 93.03738%, 내용 픽셀 중심 일치율 23.75718%, flagged 0이다. 머리말이 아닌 꼬리말 Line/Path의 본문 분리와 이동을 확인했으며 약 4px의 잔여 차이를 전체 일치로 기록하지 않는다.
- 대표 이미지 안정 경로: [pr6959-p012.png](../assets/pr_6959_6983_planet6897_20260910/pr6959-p012.png). 코멘트에는 `![PR #6959 검증 pr6959-p012.png](https://raw.githubusercontent.com/edwardkim/rhwp/<merge-commit-sha>/mydocs/pr/assets/pr_6959_6983_planet6897_20260910/pr6959-p012.png)` 형식으로 이미지를 직접 표시한다.
