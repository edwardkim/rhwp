...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5061](https://github.com/edwardkim/rhwp/pull/5061) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `1230af3f4deb` |
| 원 기능 제목 | feat(cli): edit apply-hf-template — 머리말/꼬리말 마당 적용 |
| 통합 commit | `df3775d8d` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 8 / 25 (지정된 오래된 순서) |
