...
## 판정: 승인 (탭 런 bbox 계약 한정)

목차 4쪽 형상을 대조하고 bbox/문자 경계 계약 2건을 통과했다. 출력 PDF는 히트 테스트의 직접 증거가 아니며 실제 브라우저 클릭·선택 검증은 수행하지 않았다.
...
- 검토일: 2026-09-08. [원 PR](https://github.com/edwardkim/rhwp/pull/6867), [관련 이슈](https://github.com/edwardkim/rhwp/issues/6844).
- 원 head: `ed196de9d2129adfae41698099ec0a468e604093`. [원 PR CI](https://github.com/edwardkim/rhwp/pull/6867/checks)는 확인 당시 통과했다.
- 적용 원 커밋: 66bc379251a528d6587e647f047865bc3df3a92c, ed196de9d2129adfae41698099ec0a468e604093. 로컬 커밋: c1a1a5dcf, d66f2a6a5. 체리픽의 원 커밋 출처를 보존했다.
...
![toc-p004.png](../assets/pr_6849_6867_planet6897_20260908/toc-p004.png)
