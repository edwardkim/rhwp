# PR #5240 검토 - feat(gym): table-editing pack 과제 확장 (TB09-TB40)

- PR: https://github.com/edwardkim/rhwp/pull/5240
- 작성자: `kevin9327`
- base: `devel`
- 원 head: `859777a095baa83dfb51698da005ee7d3b1f848e`
- 원본 적용 SHA: `07bf380, d2f054c, 859777a`
...
- table-editing gym pack의 과제·fixture·계약 범위를 누적 후보에 포함했다.
- 체리픽은 최신 `upstream/devel@0bc05ef81` 위에서 원 작성자 커밋 계보를 보존하는 `-x` 방식으로 누적했다.

## 메인터너 보정

- 없음. gym 산출물은 제품 코드나 새 CLI를 추가하지 않는 문서·계약 범위로 유지했다.
