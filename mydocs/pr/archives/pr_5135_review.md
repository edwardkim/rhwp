...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5135](https://github.com/edwardkim/rhwp/pull/5135) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `c90538ae5ecd` |
| 원 기능 제목 | feat(cli): edit merge-paragraph-in-footnote — 각주/미주 문단 병합 |
| 통합 commit | `ff2294605` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 24 / 25 (지정된 오래된 순서) |
