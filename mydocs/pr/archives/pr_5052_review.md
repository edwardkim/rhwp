...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5052](https://github.com/edwardkim/rhwp/pull/5052) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `2cf77c414bc1` |
| 원 기능 제목 | feat(cli): edit set-header-footer-text — 머리말/꼬리말 문단 텍스트 교체 |
| 통합 commit | `aa28ecaf7` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 5 / 25 (지정된 오래된 순서) |
