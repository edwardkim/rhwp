...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5085](https://github.com/edwardkim/rhwp/pull/5085) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `9200313f5403` |
| 원 기능 제목 | feat(cli): edit apply-char-format — 본문 글자 서식 적용 |
| 통합 commit | `65d40b3bb` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 14 / 25 (지정된 오래된 순서) |
