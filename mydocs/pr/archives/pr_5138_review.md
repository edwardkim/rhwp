...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5138](https://github.com/edwardkim/rhwp/pull/5138) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `293c73807876` |
| 원 기능 제목 | feat(cli): edit apply-para-format-in-footnote — 각주 문단 서식 적용 |
| 통합 commit | `7e234759b` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 25 / 25 (지정된 오래된 순서) |
