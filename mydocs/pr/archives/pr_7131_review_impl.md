...
# PR #7131 체리픽·검증·후속 계획

[개별 review](pr_7131_review.md)의 판정은 **승인**다. 통합 번호를 미리 만들지 않았으며
...
| 원 SHA | 로컬 SHA | 제목 |
| --- | --- | --- |
| `a72fefd9720de75c392115a9387a8b9cfc10e215` | `c061f8e1d40a847ce09df7bf10eb944040ef71b1` | 수정(진단): off-canvas 가 가로 축도 본다 — 자손 글자의 잉크 상자로 (#7051) |

기준 `93ffc3dd59c120bd54df4c2ac6d1ddbe630f8a2d` 위에서 PR 순서 7094 → 7100 → 7104 → 7111 → 7112 → 7113 → 7115 →
7116 → 7117 → 7120 → 7131 → 7132로 누적했다. 이 PR의 마지막 local SHA는 `c061f8e1d40a847ce09df7bf10eb944040ef71b1`다.
...
- [개별 review](pr_7131_review.md)의 최신 절이 이전 조사 단계·SHA보다 우선한다. 원래 조사·검증 이력은 보존한다.
