# PR #5341 검토 - agent: 실무 레시피 라우터 스킬 신설

- PR: https://github.com/edwardkim/rhwp/pull/5341
- 작성자: `kevin9327`
- base: `devel`
- 원 head: `912b8c4541ba47cc8472bd6f07ba6c610f80d861`
- 원본 적용 SHA: `912b8c4`
...
- 실무 레시피 라우터 스킬과 기존 표면 연결을 통합했다.
- 체리픽은 최신 `upstream/devel@0bc05ef81` 위에서 원 작성자 커밋 계보를 보존하는 `-x` 방식으로 누적했다.

## 메인터너 보정

- 계약 테스트를 `tests/cases/`로 이동해 파생 suite가 자동 배정한다 (`04d1a94b8`).
