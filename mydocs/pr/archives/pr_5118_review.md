...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5118](https://github.com/edwardkim/rhwp/pull/5118) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `bf9b0e41fc79` |
| 원 기능 제목 | feat(cli): edit apply-endnote-shape — 미주 모양 적용 |
| 통합 commit | `8a92d3c0d` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 20 / 25 (지정된 오래된 순서) |
