# PR #5320 검토 - agent: 시각 회귀(render-diff·ir-diff) 스킬 고도화

- PR: https://github.com/edwardkim/rhwp/pull/5320
- 작성자: `kevin9327`
- base: `devel`
- 원 head: `29658da0daa5e90b6f89e5991583d1928c17361c`
- 원본 적용 SHA: `29658da`
...
- visual-regression 스킬·fixture·계약을 통합했다.
- 체리픽은 최신 `upstream/devel@0bc05ef81` 위에서 원 작성자 커밋 계보를 보존하는 `-x` 방식으로 누적했다.

## 메인터너 보정

- 계약 테스트 원본은 `tests/cases/`로 이동해 파생 suite 정책을 따르도록 보정했다 (`04d1a94b8`).
