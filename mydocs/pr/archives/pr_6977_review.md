# PR #6977 검토: 그림 채우기의 밝기와 대비 보존

## 판정: 승인

검토일: 2026-09-10. 검토자: jangster77.

그림 채우기의 밝기·대비 전달을 검토했다. 집중 테스트 2개와 전체 회귀 테스트가 통과했다. 반복 HWPX 왕복에서 밝기 50, 대비 -15, REAL_PIC 효과와 alpha 0이 보존됨을 확인했다. 한컴 PDF와 1쪽 증적을 대조했다.

## 검토 기준과 출처

- 원 PR: https://github.com/edwardkim/rhwp/pull/6977
- 검토한 원 PR head: `776058d0c5c5d8a808976ff0dcbe71b4d31e267b`.
...
| 원본 commit | 적용 commit |
| --- | --- |
| `829f9ff55f0595f871a11e67de9713422ef9928d` | `49afff902eccfb3dbe3fe04fe8db82810fa60096` |
| `e12852b57ffb3645f051ab038249c263f6dc9525` | `2856bf6b06071cec71955513502eb85506524191` |
| `449dd944ea62ec486708deec8bc2844ea777103c` | `5090e7d3af659aac30adc8453a36ac946aced8c6` |
| `776058d0c5c5d8a808976ff0dcbe71b4d31e267b` | `0626f5d690423e1fd7645db5704aa6d2e595ab84` |
...
![PR #6977 검토 증적 pr6977-p001.png](../assets/pr_6959_6983_planet6897_20260910/pr6977-p001.png)

기준 PDF: [issue6895-watermark-2024.pdf](../../../pdf/issue6895-watermark-2024.pdf). 기존의 신뢰 가능한 한컴 PDF는 재사용하고, 필요한 최종 기준 PDF만 보관했다.

기준 PDF와 글꼴·레이아웃 위치 차이는 남는다. 기여자가 제시한 셀 채우기 이미지 ROI 측정치를 이번 통합 후보에서 새로 측정한 결과로 사용하지 않는다.
...
- 원 PR #6977에 체리픽 통합 수용 사실, 실제 통합 PR 번호와 merge SHA, 원 변경과 메인터너 보정의 차이를 기록한다. 원 PR을 직접 merge했다고 표현하지 않는다.
- Visual Sweep 및 검증 기록의 정본 direct link는 `https://github.com/edwardkim/rhwp/blob/<merge-commit-sha>/mydocs/pr/archives/pr_6977_review.md`로 고정한다.
- 실제 증적 범위: 1쪽 1개 페이지를 대조했다. pixel match 84.2179%, 내용 픽셀 중심 일치율 24.01484%, flagged 0이다. 밝기·대비 매개변수와 그림 톤을 확인했으며 전체 배치의 픽셀 일치를 주장하지 않는다.
- 대표 이미지 안정 경로: [pr6977-p001.png](../assets/pr_6959_6983_planet6897_20260910/pr6977-p001.png). 코멘트에는 `![PR #6977 검증 pr6977-p001.png](https://raw.githubusercontent.com/edwardkim/rhwp/<merge-commit-sha>/mydocs/pr/assets/pr_6959_6983_planet6897_20260910/pr6977-p001.png)` 형식으로 이미지를 직접 표시한다.
