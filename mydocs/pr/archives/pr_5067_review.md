...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5067](https://github.com/edwardkim/rhwp/pull/5067) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `1b77ef1998e0` |
| 원 기능 제목 | feat(cli): edit toggle-hide-hf — 쪽 머리말/꼬리말 감추기 토글 |
| 통합 commit | `db1b87a3d` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 12 / 25 (지정된 오래된 순서) |
