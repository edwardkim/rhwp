...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5088](https://github.com/edwardkim/rhwp/pull/5088) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `7fba250d3e77` |
| 원 기능 제목 | feat(cli): edit split-paragraph — 본문 문단 분할 (#5082) |
| 통합 commit | `c3d85c26e` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 15 / 25 (지정된 오래된 순서) |
