...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5054](https://github.com/edwardkim/rhwp/pull/5054) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `d8539a7ee72b` |
| 원 기능 제목 | feat(cli): header-footer — 머리말/꼬리말 한 건 조회 |
| 통합 commit | `95be375d0` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 7 / 25 (지정된 오래된 순서) |
