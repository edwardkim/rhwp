...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5107](https://github.com/edwardkim/rhwp/pull/5107) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `6aaccdb6a7bb` |
| 원 기능 제목 | feat(cli): edit set-numbering-restart — 문단 번호 다시 시작 |
| 통합 commit | `964c388eb` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 18 / 25 (지정된 오래된 순서) |
