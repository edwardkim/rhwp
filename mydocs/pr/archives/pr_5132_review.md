...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5132](https://github.com/edwardkim/rhwp/pull/5132) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `51ea9f89d6cc` |
| 원 기능 제목 | feat(cli): edit delete-text-in-footnote — 각주/미주 텍스트 삭제 |
| 통합 commit | `4fd6cea72` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 22 / 25 (지정된 오래된 순서) |
