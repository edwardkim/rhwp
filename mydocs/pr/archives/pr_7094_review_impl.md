...
# PR #7094 체리픽·검증·후속 계획

[개별 review](pr_7094_review.md)의 판정은 **승인**다. 통합 번호를 미리 만들지 않았으며
...
| 원 SHA | 로컬 SHA | 제목 |
| --- | --- | --- |
| `3ba97a74cde1cc927c31b5843be2bcf91de2b07d` | `69353a38423e186107ae230a1d9393e330432bc9` | 수정: 합성 쪽나눔을 HWP5 저장본에 쓰지 않는다 — 한글이 쪽을 불린다 (#4680) |

기준 `93ffc3dd59c120bd54df4c2ac6d1ddbe630f8a2d` 위에서 PR 순서 7094 → 7100 → 7104 → 7111 → 7112 → 7113 → 7115 →
7116 → 7117 → 7120 → 7131 → 7132로 누적했다. 이 PR의 마지막 local SHA는 `69353a38423e186107ae230a1d9393e330432bc9`다.
...
- [개별 review](pr_7094_review.md)의 최신 절이 이전 조사 단계·SHA보다 우선한다. 원래 조사·검증 이력은 보존한다.
