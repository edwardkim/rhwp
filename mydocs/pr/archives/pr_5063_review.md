...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5063](https://github.com/edwardkim/rhwp/pull/5063) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `3d8cf697647b` |
| 원 기능 제목 | feat(cli): edit delete-hf-text — 머리말/꼬리말 텍스트 삭제 |
| 통합 commit | `1a83df898` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 9 / 25 (지정된 오래된 순서) |
