...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5038](https://github.com/edwardkim/rhwp/pull/5038) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `1266202d312b` |
| 원 기능 제목 | feat(cli): edit rename-bookmark — 책갈피 이름 변경 (#5033) |
| 통합 commit | `92d1524c6` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 1 / 25 (지정된 오래된 순서) |
