# PR #5338 검토 - agent: 기여 절차(contributor) 스킬 고도화

- PR: https://github.com/edwardkim/rhwp/pull/5338
- 작성자: `kevin9327`
- base: `devel`
- 원 head: `fef35dd3bf6aed2fe32e09d281e09a70cdcb3b8d`
- 원본 적용 SHA: `fef35dd`
...
- 기여 절차 스킬·검증 게이트·정책 계약을 통합했다.
- 체리픽은 최신 `upstream/devel@0bc05ef81` 위에서 원 작성자 커밋 계보를 보존하는 `-x` 방식으로 누적했다.

## 메인터너 보정

- 계약 검사에서 clippy가 요구한 범위 패턴을 보정했다 (`1f85681c3`).
