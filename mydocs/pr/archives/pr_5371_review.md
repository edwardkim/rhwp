# PR #5371 검토 - feat(layout-anomaly): --batch 폴더 스윕과 --types 필터

- PR: https://github.com/edwardkim/rhwp/pull/5371
- 작성자: `kevin9327`
- base: `devel`
- 원 head: `6998e898b0784aece4070c2ee220a069a2a248ec`
- 원본 적용 SHA: `6998e89`
...
- layout-anomaly의 batch 폴더 스윕·타입 필터·NDJSON 진단 계약을 통합했다.
- 체리픽은 최신 `upstream/devel@0bc05ef81` 위에서 원 작성자 커밋 계보를 보존하는 `-x` 방식으로 누적했다.

## 메인터너 보정

- 집중 layout-anomaly 회귀와 전체 7,153개 회귀를 통과했다. 진단 기능이며 렌더 출력 변경을 주장하지 않는다.
