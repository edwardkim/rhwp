# PR #6978 검토: 전체 쪽 TAC 그림의 줄과 페이지 소유권

## 판정: 승인

검토일: 2026-09-10. 검토자: jangster77.

전체 쪽 TAC 그림이 다음 페이지 내용의 줄·페이지 소유권을 가져가지 않도록 하는 변경을 검토했다. 집중 테스트 2개와 전체 회귀 테스트가 통과했다. 한컴 PDF와 1·2쪽을 대조하여 표지 그림은 1쪽, 후속 표는 2쪽에 배치되고 전체 12쪽이 일치함을 확인했다.

## 검토 기준과 출처

- 원 PR: https://github.com/edwardkim/rhwp/pull/6978
- 검토한 원 PR head: `607e18a61a3ff9c06256b5ab05c441ecca74749f`.
...
| 원본 commit | 적용 commit |
| --- | --- |
| `784800bfe52177745b6198ab0a3a8b58b9e250ef` | `85e0ff86713595faaae4e90fe586b2765b612f66` |
| `607e18a61a3ff9c06256b5ab05c441ecca74749f` | `a792649d0ee8c74b9e511e0cc19f58ec7ad1818b` |
...
![PR #6978 검토 증적 pr6978-p001.png](../assets/pr_6959_6983_planet6897_20260910/pr6978-p001.png)

![PR #6978 검토 증적 pr6978-p002.png](../assets/pr_6959_6983_planet6897_20260910/pr6978-p002.png)

기준 PDF: [56288-regulatory-impact-2020.pdf](../../../pdf/56288-regulatory-impact-2020.pdf). 기존의 신뢰 가능한 한컴 PDF는 재사용하고, 필요한 최종 기준 PDF만 보관했다.

글꼴과 표 선의 표현 차이는 남으며, 전체 문서의 픽셀 일치를 주장하지 않는다.
...
- 원 PR #6978에 체리픽 통합 수용 사실, 실제 통합 PR 번호와 merge SHA, 원 변경과 메인터너 보정의 차이를 기록한다. 원 PR을 직접 merge했다고 표현하지 않는다.
- Visual Sweep 및 검증 기록의 정본 direct link는 `https://github.com/edwardkim/rhwp/blob/<merge-commit-sha>/mydocs/pr/archives/pr_6978_review.md`로 고정한다.
- 실제 증적 범위: 1·2쪽 2개 페이지를 대조했다. 평균 pixel match 93.87582%, 평균 내용 픽셀 중심 일치율 36.19816%, flagged 0이다. 표지 그림은 1쪽, 표는 2쪽에 있으며 전체 12쪽임을 확인했다.
- 대표 이미지 안정 경로: [pr6978-p001.png](../assets/pr_6959_6983_planet6897_20260910/pr6978-p001.png). 코멘트에는 `![PR #6978 검증 pr6978-p001.png](https://raw.githubusercontent.com/edwardkim/rhwp/<merge-commit-sha>/mydocs/pr/assets/pr_6959_6983_planet6897_20260910/pr6978-p001.png)` 형식으로 이미지를 직접 표시한다.
- 대표 이미지 안정 경로: [pr6978-p002.png](../assets/pr_6959_6983_planet6897_20260910/pr6978-p002.png). 코멘트에는 `![PR #6978 검증 pr6978-p002.png](https://raw.githubusercontent.com/edwardkim/rhwp/<merge-commit-sha>/mydocs/pr/assets/pr_6959_6983_planet6897_20260910/pr6978-p002.png)` 형식으로 이미지를 직접 표시한다.
