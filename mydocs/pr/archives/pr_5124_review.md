...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5124](https://github.com/edwardkim/rhwp/pull/5124) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `95db42db6939` |
| 원 기능 제목 | feat(cli): edit insert-footnote-text — 각주 텍스트 삽입 (#5110) |
| 통합 commit | `e9096f5c8` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 21 / 25 (지정된 오래된 순서) |
