...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5069](https://github.com/edwardkim/rhwp/pull/5069) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `75e823790446` |
| 원 기능 제목 | feat(cli): edit merge-paragraph-in-hf — 머리말/꼬리말 문단 병합 |
| 통합 commit | `e2672078b` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 13 / 25 (지정된 오래된 순서) |
