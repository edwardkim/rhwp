...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5066](https://github.com/edwardkim/rhwp/pull/5066) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `d7c29107c0c7` |
| 원 기능 제목 | feat(cli): edit split-paragraph-in-hf — 머리말/꼬리말 문단 분할 |
| 통합 commit | `ca3fa9214` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 11 / 25 (지정된 오래된 순서) |
