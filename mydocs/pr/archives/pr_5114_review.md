...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5114](https://github.com/edwardkim/rhwp/pull/5114) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `4d78b1fe0e6e` |
| 원 기능 제목 | feat(cli): edit apply-para-format-in-hf — 머리말/꼬리말 문단 서식 (#5109) |
| 통합 commit | `19f321a53` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 19 / 25 (지정된 오래된 순서) |
