...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5133](https://github.com/edwardkim/rhwp/pull/5133) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `7c8eb6dc6f49` |
| 원 기능 제목 | feat(cli): edit split-paragraph-in-footnote — 각주/미주 문단 분할 |
| 통합 commit | `4dfe62df3` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 23 / 25 (지정된 오래된 순서) |
