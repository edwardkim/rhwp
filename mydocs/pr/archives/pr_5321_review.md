# PR #5321 검토 - agent: explore 메뉴 라우팅 스킬 고도화

- PR: https://github.com/edwardkim/rhwp/pull/5321
- 작성자: `kevin9327`
- base: `devel`
- 원 head: `9813aa8b84cc71299387ccb287970f06a512ae5a`
- 원본 적용 SHA: `9813aa8`
...
- explore 메뉴 라우팅 스킬과 기존 CLI 표면 연결을 검토했다.
- 체리픽은 최신 `upstream/devel@0bc05ef81` 위에서 원 작성자 커밋 계보를 보존하는 `-x` 방식으로 누적했다.

## 메인터너 보정

- 없음. 새 명령을 도입하지 않고 `explore`의 광고 표면을 사용한다.
