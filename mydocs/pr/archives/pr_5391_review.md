# PR #5391 검토 - test: 어댑터 capability 광고 vs 실지원 계약 (M06-3)

- PR: https://github.com/edwardkim/rhwp/pull/5391
- 작성자: `kevin9327`
- base: `devel`
- 원 head: `81a8953ed738facf5e018e93eed8e6e542ef3c29`
- 원본 적용 SHA: `81a8953`
...
- render backend capability 광고와 PNG/Skia 실지원 계약을 통합했다.
- 체리픽은 최신 `upstream/devel@0bc05ef81` 위에서 원 작성자 커밋 계보를 보존하는 `-x` 방식으로 누적했다.

## 메인터너 보정

- PNG/Skia 모듈 충돌에서는 원 PR의 capability helper·테스트 구조를 유지해 둘 다의 export를 보존했다. Native Skia 게이트로 재검증했다.
