...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5065](https://github.com/edwardkim/rhwp/pull/5065) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `a7f43d331cab` |
| 원 기능 제목 | feat(cli): edit insert-field-in-hf — 머리말/꼬리말 필드 삽입 |
| 통합 commit | `0a979067e` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 10 / 25 (지정된 오래된 순서) |
