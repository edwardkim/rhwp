...
- HWP3 각주 구분선의 위·아래·주석 사이 여백을 HWP5 필드로 보존했습니다.
- 실제 FOOTNOTE_SHAPE의 852/568/424가 독립 한컴 HWP5와 일치하며, PDF 9쪽의 본문 끝·구분선·첫 각주 행을 직접 대조했습니다.
...
- 구분선 길이와 미주 shape 차이가 남아 #7174는 유지합니다. 관련 이슈 #7174는 부분 개선을 기록하고 OPEN을 유지합니다.
