...
# PR #7132 체리픽·검증·후속 계획

[개별 review](pr_7132_review.md)의 판정은 **승인**다. 통합 번호를 미리 만들지 않았으며
...
| 원 SHA | 로컬 SHA | 제목 |
| --- | --- | --- |
| `8b3a3ce576da92b1485c944b2b2f04456dbca803` | `48afe0f95abc4cd76b002dfc314f3cc044f10b31` | 수정(renderer/wmf): META_TEXTOUT 채움 바이트를 글자로 그리지 않는다 (#7130) |

기준 `93ffc3dd59c120bd54df4c2ac6d1ddbe630f8a2d` 위에서 PR 순서 7094 → 7100 → 7104 → 7111 → 7112 → 7113 → 7115 →
7116 → 7117 → 7120 → 7131 → 7132로 누적했다. 이 PR의 마지막 local SHA는 `48afe0f95abc4cd76b002dfc314f3cc044f10b31`다.
...
- [개별 review](pr_7132_review.md)의 최신 절이 이전 조사 단계·SHA보다 우선한다. 원래 조사·검증 이력은 보존한다.
