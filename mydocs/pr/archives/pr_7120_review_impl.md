...
# PR #7120 체리픽·검증·후속 계획

[개별 review](pr_7120_review.md)의 판정은 **승인**다. 통합 번호를 미리 만들지 않았으며
...
| 원 SHA | 로컬 SHA | 제목 |
| --- | --- | --- |
| `098e351782d3cf35474ab11819f3d2e5af67d51f` | `0e56620fe21b854037db92b6fa93b63fe6599de2` | 수정: 근사-축소를 표 첫 칸의 저장 사다리로 가른다 (#7059) |

기준 `93ffc3dd59c120bd54df4c2ac6d1ddbe630f8a2d` 위에서 PR 순서 7094 → 7100 → 7104 → 7111 → 7112 → 7113 → 7115 →
7116 → 7117 → 7120 → 7131 → 7132로 누적했다. 이 PR의 마지막 local SHA는 `0e56620fe21b854037db92b6fa93b63fe6599de2`다.
...
- [개별 review](pr_7120_review.md)의 최신 절이 이전 조사 단계·SHA보다 우선한다. 원래 조사·검증 이력은 보존한다.
