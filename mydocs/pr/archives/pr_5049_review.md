...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5049](https://github.com/edwardkim/rhwp/pull/5049) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `09ec4181d989` |
| 원 기능 제목 | feat(cli): headers-footers — 머리말/꼬리말 목록 (#5044) |
| 통합 commit | `6343814d7` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 4 / 25 (지정된 오래된 순서) |
