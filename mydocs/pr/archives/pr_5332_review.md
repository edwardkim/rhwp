# PR #5332 검토 - agent: 실사례 버그 헌팅(bug-hunter) 스킬 고도화

- PR: https://github.com/edwardkim/rhwp/pull/5332
- 작성자: `kevin9327`
- base: `devel`
- 원 head: `581a5e8709305cd0c52405305ad06d554fcff214`
- 원본 적용 SHA: `581a5e8`
...
- 실문서 여정·정답지 대조 bug-hunter 스킬 포인터와 계약을 통합했다.
- 체리픽은 최신 `upstream/devel@0bc05ef81` 위에서 원 작성자 커밋 계보를 보존하는 `-x` 방식으로 누적했다.

## 메인터너 보정

- 계약 테스트를 `tests/cases/`로 이동하고 포인터에 실제 `rhwp info --json` 관측 진입점을 기록했다 (`04d1a94b8`, `c9f88fd86`).
