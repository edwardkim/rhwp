...
- 원 PR [#7272](https://github.com/edwardkim/rhwp/pull/7272): 수정(renderer): 고정폭 표의 작은따옴표를 적힌 전각 폭으로 잰다 (#7092)
- 작성자 planet6897, nondraft, 검토 전 reviewer jangster77 지정.
- 원 head `6f36b4bb527376bae661b07cbf4546d2674bbcef` → cherry-pick `2b7e621f7670795d2288319cdf6290e8f577eee7`.
...
고정폭 metric의 `‘’` 폭을 0.3em 강제값/반각 fallback에서 제외한다. 비고정폭 경로는 유지한다.
issue157 2쪽 PDF·base·통합 Native 직접 비교에서 작은따옴표 간격 개선을 확인했다.
굴림체·돋움체 양성, 휴먼명조 음성 테스트 PASS. 원 작성자의 623 PDF 전수 주장은 독립 재실행하지 않았다.
기존 golden 변경은 해당 문맥의 전진폭 변화이며 내용 소실을 허용하는 baseline 완화가 아니다.
따옴표 수정 단독으로 Table/Cell/Image/RawSvg 기하는 유지됐다. 이후 #7275를 누적한 최종본은 표 x가 약3.77px 이동하며, 구조·텍스트·y·w·h는 그대로다.
#7092의 비고정폭/기호 슬롯 차이는 남아 이슈는 닫지 않는다.
...
| --- | --- | --- | --- |
| quote / 2 | `samples/hwpx/issue_157.hwpx` | `pdf/hwpx/issue_157-hwpx-2020.pdf` | 2: 33.71615% |
...
- [native_quote_compare_002.png](../assets/pr7272_review/native_quote_compare_002.png)
- [native_quote_overlay_002.png](../assets/pr7272_review/native_quote_overlay_002.png)
- [native_quote_review_002.png](../assets/pr7272_review/native_quote_review_002.png)
- [wasm_quote_compare_002.png](../assets/pr7272_review/wasm_quote_compare_002.png)
- [wasm_quote_overlay_002.png](../assets/pr7272_review/wasm_quote_overlay_002.png)
- [wasm_quote_review_002.png](../assets/pr7272_review/wasm_quote_review_002.png)
