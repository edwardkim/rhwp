...
HWP 18쪽, HWPX 15쪽으로 기준 쪽수와 일치하고 이전 빈 쪽 위치에 본문이 존재한다. 글꼴·행 위치·전체 페이지별 내용 배치까지 동일한 것은 아니다. #6853의 통합 보정은 테스트 가정 변경에 그치지 않고 원문 빈 문단·표 뒤 간격을 복원했다. 최종 8스레드 전체 회귀에서 빈 고아 쪽 제거와 그래프 분할 계약이 함께 통과했다.
...
- 검토일: 2026-09-08. [원 PR](https://github.com/edwardkim/rhwp/pull/6857), [관련 이슈](https://github.com/edwardkim/rhwp/issues/6854).
- 원 head: `5894984a402cecc9a605ade9970501c2d924a115`. [원 PR CI](https://github.com/edwardkim/rhwp/pull/6857/checks)는 확인 당시 통과했다.
- 적용 원 커밋: 5894984a402cecc9a605ade9970501c2d924a115. 로컬 커밋: 74ad064a8. 체리픽의 원 커밋 출처를 보존했다.
...
![orphan-hwp-p014.png](../assets/pr_6849_6867_planet6897_20260908/orphan-hwp-p014.png)

![orphan-hwpx-p010.png](../assets/pr_6849_6867_planet6897_20260908/orphan-hwpx-p010.png)
