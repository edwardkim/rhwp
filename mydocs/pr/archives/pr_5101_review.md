...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5101](https://github.com/edwardkim/rhwp/pull/5101) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `db0bde9a1962` |
| 원 기능 제목 | feat(cli): edit apply-style — 본문 문단 스타일 적용 |
| 통합 commit | `77f1c0bcd` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 17 / 25 (지정된 오래된 순서) |
