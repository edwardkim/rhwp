...
| 항목 | 값 |
| --- | --- |
| 원 PR | [#5096](https://github.com/edwardkim/rhwp/pull/5096) |
| 작성자 | `kevin9327` |
| 원 기능 SHA | `acc45c62d135` |
| 원 기능 제목 | feat(cli): edit apply-para-format — 본문 문단 서식 적용 |
| 통합 commit | `b3de3b016` (Author: `kevin9327`, Committer: `jangster77`) |
| 적용 순서 | 16 / 25 (지정된 오래된 순서) |
