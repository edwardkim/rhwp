# PR #5325 검토 - agent: 폴더 일괄 파이프라인(batch) 스킬 고도화

- PR: https://github.com/edwardkim/rhwp/pull/5325
- 작성자: `kevin9327`
- base: `devel`
- 원 head: `5d1e30f57d403f164f28e289bfbc941e2451f28c`
- 원본 적용 SHA: `5d1e30f`
...
- bulk-pipeline 스킬의 batch 일괄 처리·실패 봉투·예제 계약을 통합했다.
- 체리픽은 최신 `upstream/devel@0bc05ef81` 위에서 원 작성자 커밋 계보를 보존하는 `-x` 방식으로 누적했다.

## 메인터너 보정

- 계약 테스트를 `tests/cases/`로 이동하고 누락된 `examples/10_mixed_failure_gate.md`를 추가했다 (`04d1a94b8`, `c9f88fd86`).
