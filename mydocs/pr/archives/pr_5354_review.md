# PR #5354 검토 - agent: 지식 지도(knowledge map) 스킬 신설

- PR: https://github.com/edwardkim/rhwp/pull/5354
- 작성자: `kevin9327`
- base: `devel`
- 원 head: `c3c0b04c11e73eb3ece03b1b7a0c1ff2be0c3443`
- 원본 적용 SHA: `c3c0b04`
...
- knowledge-map 스킬과 봉투 필드 역인덱스 계약을 통합했다.
- 체리픽은 최신 `upstream/devel@0bc05ef81` 위에서 원 작성자 커밋 계보를 보존하는 `-x` 방식으로 누적했다.

## 메인터너 보정

- `offCanvasCount`를 §2-2 사전에 추가하고 실제 수치 324 self-described / 332 total로 갱신했다. peer-skill 존재 계약도 현재 표면에 맞췄다 (`c9f88fd86`, `cd9f557ac`).
