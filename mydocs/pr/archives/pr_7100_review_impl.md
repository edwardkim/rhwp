...
# PR #7100 체리픽·검증·후속 계획

[개별 review](pr_7100_review.md)의 판정은 **승인**다. 통합 번호를 미리 만들지 않았으며
...
| 원 SHA | 로컬 SHA | 제목 |
| --- | --- | --- |
| `977f2caa5df9861b73eac35ddc38d8d707dedae9` | `9a21d89f496074ebefd15dcb8867028e5052a78a` | 수정(renderer): 칸 마지막 줄이 완전한 빈 줄이면 trailing 줄간격을 행 높이에서 뺀다 (#7097) |

기준 `93ffc3dd59c120bd54df4c2ac6d1ddbe630f8a2d` 위에서 PR 순서 7094 → 7100 → 7104 → 7111 → 7112 → 7113 → 7115 →
7116 → 7117 → 7120 → 7131 → 7132로 누적했다. 이 PR의 마지막 local SHA는 `9a21d89f496074ebefd15dcb8867028e5052a78a`다.
...
- [개별 review](pr_7100_review.md)의 최신 절이 이전 조사 단계·SHA보다 우선한다. 원래 조사·검증 이력은 보존한다.
