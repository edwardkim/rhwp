...
# PR #5267 검토 — gym: core-cli T15+ · casual-rides CR05+ 입문/코어 온램프 확장
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#5267](https://github.com/edwardkim/rhwp/pull/5267) / @kevin9327 |
| 원 head | `ed4d08276453aeca14f7a22c8931a2bf35584608` |
| 기준 devel | `0bc05ef81107ac61ec38d622f71b44a44d1b4821` |
| 검토 브랜치 | `review/kevin9327-5212-5314-20260818` |
| 기능 source → 누적 적용 | `ed4d082` → `3cb32825` |
...
core-cli와 casual-rides의 입문·코어 과제를 확장한다. family/starter 프로파일 및 pack 회귀가 변경 Python 검증군에서 통과했다.
