...
# PR #5299 검토 — agent: MCP 세션 규약·스킬 고도화
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#5299](https://github.com/edwardkim/rhwp/pull/5299) / @kevin9327 |
| 원 head | `cf73acd55e7ec093c2bfd3935efda8d5b4cb06bc` |
| 기준 devel | `0bc05ef81107ac61ec38d622f71b44a44d1b4821` |
| 검토 브랜치 | `review/kevin9327-5212-5314-20260818` |
| 기능 source → 누적 적용 | `cf73acd` → `a5bf2c16` |
...
MCP session 규약과 agent skill 문서를 고도화한다. agent_mcp_session Python 시험과 관련 integration contract suite에서 정합을 확인했다.
