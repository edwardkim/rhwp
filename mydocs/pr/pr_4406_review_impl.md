...
| maintainer review | 이 문서와 `pr_4406_review.md`의 후속 기록 커밋 |

## 단계

1. 원 PR head, fork source ref, 수정 권한을 대조했다.
2. contributor history 위에 code·test 보정만 추가하고 replay·audit·lineage·unit 회귀 10개를 통과했다.
...
문제가 생기면 review commit과 `7584408f`만 역순 revert한다. contributor commit은 amend,
