...
### `edit merge-paragraph-in-footnote <파일> [--section N] [--para N] [--ctrl N] [--fn-para N] [-o <출력>] [--dry-run] [--verify] [--json]`
각주/미주 문단을 바로 앞 문단에 합친다. 코어 `merge_paragraph_in_footnote_native`. `--fn-para` 는 1 이상.
