...
| `CAP-3398` | `bug-hunter` | 실사례 여정과 정답지 대조로 재현 가능한 결함을 발굴. 수정 구현은 요청 시 별도 작업 | [버그 헌팅 playbook](bug_hunting_playbook.md) | [에이전트](../../.claude/agents/bug-hunter.md) · [Skill 포인터](../../.claude/skills/rhwp-bug-hunter/SKILL.md) | [Skill](../../.agents/skills/bug-hunter/SKILL.md) | active · rhwp maintainers |
