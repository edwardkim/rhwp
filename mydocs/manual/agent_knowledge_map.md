...
| `ctrl` | number | 문단 안 컨트롤 인덱스 (0부터) | `edit delete-footnote`·`delete-bookmark`·`rename-bookmark`·`delete-control`·`delete-shape` |
...
| `count` | number | 지울 글자 수(1 이상) 또는 묶을 개체 수 | `edit delete-text`·`group-shapes` |
