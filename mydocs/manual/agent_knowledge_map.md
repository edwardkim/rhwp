...
`assertions`·`docId`·`preview` **3개**를 합친 304개다. `등장 명령` 은 자기서술
...
| `innerPara` | number | 셀·각주 안 문단 (0부터) | `edit apply-char-format-in-cell`·`apply-para-format-in-cell`·`apply-para-format-in-footnote` |
| `props` | string | 글자/문단 서식 JSON | `edit apply-char-format-in-cell`·`apply-para-format-in-cell`·`apply-para-format-in-footnote` |
