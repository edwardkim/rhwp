...
- **상태**: R0 `qualified-red`, R1 `qualified`; R2 승인 대기
...
`Q2-D5-R0` red 계약을 qualified-red로 고정했고 `Q2-D5-R1` unique-source prepared identity cache를 qualified로
마쳤다. 다음 승인은 `Q2-D5-R2` opt-in font-by-key transport만 연다. R2·R3·N0·N1·N2는 각 결과 보고와
메인테이너 승인 뒤 다음 절편으로
