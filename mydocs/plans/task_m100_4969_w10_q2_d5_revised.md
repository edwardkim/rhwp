...
- **상태**: R0 `qualified-red`, R1·R2·R3·N0·N1 `qualified`; N2 승인 대기
...
owner·rollback 계약과 `Q2-D5-N1` atomic activation을 qualified로 마쳤다. 다음 승인은 최종 cross-backend·성능
판정인 `Q2-D5-N2`만 연다. N2 결과 보고와 메인테이너 승인 전에는 Q2 최종 support classification을 확정하지
않는다. commit·remote push·PR 생성·GitHub comment·merge는 기존 별도 승인 경계를 유지한다.
