...
이번 주에 대사한 2026년 에이전트 **하네스(harness/scaffold) 논문 5편**을 실측
인용하고, 각 축을 이 저장소의 **머지 실물**과 **검토 중인 open PR**에 나눠
대사한다. 다섯 편의 최초 제출일은 각각 2026-04-18, 2026-06-11,
2026-07-04, 2026-07-30, 2026-08-05이며, 이 중 이번 주 신간은
2608.05446 한 편이다.
...
|---|---|---|
| [하네스 진화가 코딩 에이전트 품질을 지배한다](https://arxiv.org/abs/2607.03691) (2607.03691, 2026-07-04; v2 2026-07-20) | 모델이 아니라 **하네스가 품질 변수** | **머지 실물:** 자기서술·계약·게이트를 제품 표면으로 다루는 R1~R100 로드맵과 진행 집계(R94). 전도 #4368은 이 구조를 설명하는 문서 근거다. |
| [Harness as an Asset — 결정론 강제](https://arxiv.org/abs/2604.17025) (2604.17025, 2026-04-18; v2 2026-05-04) | 하네스 수준의 **결정론** | **머지 실물:** 자기서술·검색·explain의 모델 무개입(R31·R33). **검토 중 PR:** 안정 노드 ID 트리와 변이 SHA-256 저널(#4361), 계획 `preconditions.inputSha256` + `edit --expect-sha256` CAS(#4381). |
| [EvoHarness-RL — 장기 지평 자기진화 런타임 하네스](https://arxiv.org/abs/2608.05446) (2608.05446, 2026-08-05; 이번 주) | 하네스의 **자기 진화** | **머지 실물:** 버전 정책 canonical과 트랙 S 계획(R171~180). **검토 중 PR:** schemaRegistry 소비자 대사 채널(#4330). **비목표:** 학습(RL) 기반 하네스 변형은 결정론·감사 가능성과 다른 축이므로 채택하지 않는다. |
...
| [Recursive Agent Harnesses](https://arxiv.org/abs/2606.13643) (2606.13643, 2026-06-11) | **계층·재귀** 하네스 | **머지 실물:** 무상태 CLI와 세션 계층. **검토 중 PR:** 안정 ID·저널을 갖춘 persistent workspace(#4361)와 CAS(#4381). 다중 에이전트 재귀는 트랙 C(R21~30)·지평 P(R141~150)의 계획이며 구현 완료 주장이 아니다. |
