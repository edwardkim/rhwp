...
- 상태: C2 native 구현·집중 119건·Rust lint 완료. 실물 메인테이너 판정 대기, #3587 완료 선언이 아니다.
...
기존 행과 뒤쪽 양식이 보존되는지 메인테이너가 한컴으로 확인한다. 자동 재열기 결과를 한컴
시각 판정으로 대신하지 않는다. 검사용 projection은 복제 셀만 담은 임시 원형 사본이고,
