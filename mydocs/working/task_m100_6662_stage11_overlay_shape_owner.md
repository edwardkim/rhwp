...
[12단계](task_m100_6662_stage12_sweep_viewport.md)에서 SVG 좌표와 독립 raster 검사를
대조한 결과, 위 하단 소실 관찰은 Chrome 캡처 viewport 결함이었다. 캡처 도구만
수정하고 동일 CLI로 재산출하면 한국어의 하단선과 로고 전체가 보인다. 이를 추가
renderer clip 확장 근거로 사용하지 않는다.
