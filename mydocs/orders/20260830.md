...
| Issue | 타스크 | 상태 | 비고 |
| --- | --- | --- | --- |
| [#6395](https://github.com/edwardkim/rhwp/issues/6395) | rhwp-studio 쪽 나누기 후 새 쪽 캐럿·화면 스크롤 동기화 | 진행중 | [PR #6396](https://github.com/edwardkim/rhwp/pull/6396) Open. TypeScript·전체 unit·build·실제 Chrome E2E 통과. [self-review](../pr/archives/pr_6396_review.md)를 기록했고 최신 head CI와 merge 승인을 기다린다. |
