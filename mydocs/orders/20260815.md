...
## Issue #4739 - Canvas2D 첫 KoPub face와 PDF oracle provenance

- 전용 worktree `/tmp/rhwp-4739`의 `task/4739-canvas-local-font-first-layout` 브랜치를 최신
  `upstream/devel@44bcba400`으로 fast-forward했다. 기존 브랜치에는 고유 커밋이 없었고 사라진
  worktree 등록만 정리했다.
