...
- [PR #4857](https://github.com/edwardkim/rhwp/pull/4857)를 `devel` 대상으로 Open 생성했다.
  collaborator 자체 PR이므로 reviewer는 지정하지 않았고,
  [자체검토 기록](../pr/archives/pr_4857_review.md)에 대형 PR 범위와 검증 근거를 남겼다. 최신
  GitHub Actions와 mergeability 확인, 작업지시자 승인 전에는 merge하지 않는다.
