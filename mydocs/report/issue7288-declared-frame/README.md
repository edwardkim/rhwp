...
source head — 아래 참조 (base: #7348 구조 분리 반영 후 devel `7a95e46e0`).

⚠ 이 증적은 구조 분리 **전** 코드(`8e8ce950e`, base `1966af77f`)에서 산출했다. 이식 뒤
규칙·기대값·시험은 동일하고 전체 게이트도 다시 통과했으나, PNG 를 재생성하지는 않았다.
