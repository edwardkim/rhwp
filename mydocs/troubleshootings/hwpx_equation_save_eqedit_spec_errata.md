...
`mydocs/tech/investigations/issue-1061/probes/dump_equation_records.rs` 의 IR diff 결과:
...
Stage 1 단독으로 부족. **EQEDIT raw payload 직접 분석** (`mydocs/tech/investigations/issue-1061/probes/dump_eqedit_raw.rs`):
