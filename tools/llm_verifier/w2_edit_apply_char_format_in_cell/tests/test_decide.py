...
from w2_edit_apply_char_format_in_cell.decide import decide, RULES, COMMAND, FAMILY

class DecideTests(unittest.TestCase):
    def test_rule_count(self) -> None:
        self.assertGreaterEqual(len(RULES), 40)
        self.assertEqual(COMMAND, 'edit-apply-char-format-in-cell')
        self.assertEqual(FAMILY, 'coord')
