...
from w2_agent_surface_stateless.decide import decide, RULES, COMMAND, FAMILY

class DecideTests(unittest.TestCase):
    def test_rule_count(self) -> None:
        self.assertGreaterEqual(len(RULES), 40)
        self.assertEqual(COMMAND, 'agent-surface-stateless')
        self.assertEqual(FAMILY, 'layer')
