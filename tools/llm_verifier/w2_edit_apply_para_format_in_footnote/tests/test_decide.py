...
from w2_edit_apply_para_format_in_footnote.decide import decide, RULES, COMMAND, FAMILY

class DecideTests(unittest.TestCase):
    def test_rule_count(self) -> None:
        self.assertGreaterEqual(len(RULES), 40)
        self.assertEqual(COMMAND, 'edit-apply-para-format-in-footnote')
        self.assertEqual(FAMILY, 'reread')
