...
from w2_mcp_hwp_doc_export_text.decide import decide, RULES, COMMAND, FAMILY

class DecideTests(unittest.TestCase):
    def test_rule_count(self) -> None:
        self.assertGreaterEqual(len(RULES), 40)
        self.assertEqual(COMMAND, 'mcp-hwp-doc-export-text')
        self.assertEqual(FAMILY, 'bound')
