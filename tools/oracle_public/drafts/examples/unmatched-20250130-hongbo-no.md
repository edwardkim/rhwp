---
title: "[오라클] unmatched-20250130-hongbo-no: pdf_pages 0 (>= 12)"
labels: bug
draft: true
submit: never
---

# [오라클] unmatched-20250130-hongbo-no: pdf_pages 0 (>= 12)
...
문서 `samples/20250130-hongbo-no.hwp` 가 한컴 기준 대비 임계 게이트를 넘었습니다.
...
짝 없는 샘플. 이유 `no_oracle_pdf` · 근접 PDF 0건.
...
한컴 기준 PDF `(없음)` 와 같은 쪽수·레이아웃이어야 합니다.
...
- 문서 id: `unmatched-20250130-hongbo-no`
