...
문서 `samples/task1725/text_footnote_tail_overpagination.hwp` 가 한컴 기준 대비 임계 게이트를 넘었습니다.
...
cheap 스윕 판정 `CHEAP_OK` · 한컴 2024 · 군 `footnote` · 쪽수 엔진/visual_sweep 미사용.
...
```
python tools/oracle_public/page_smoke.py --pair samples/task1725/text_footnote_tail_overpagination.hwp pdf/task1725/text_footnote_tail_overpagination-hwp-2024.pdf
```
...
한컴 기준 PDF `pdf/task1725/text_footnote_tail_overpagination-hwp-2024.pdf` 와 같은 쪽수·레이아웃이어야 합니다.
