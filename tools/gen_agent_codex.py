...
LIVE = {
    ...
    "headers-footers": (["headers-footers", DOC, "--json"], "문서 머리말/꼬리말 목록"),
...
FAMILIES = [
    ("10_조회", "조회 — 문서를 읽고 파악한다",
     ["info", "word-count", "bookmarks", "headers-footers", "explain", "digest", "search", "export-text", "export-structure", "fields", "dump-pages", "extract-pages"]),
