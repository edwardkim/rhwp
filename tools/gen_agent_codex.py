...
FAMILIES = [
    ...
    ("30_편집과_계획", "편집·계획 — 원본 무훼손 변경",
     ["edit", "edit replace-text", "edit set-cell", "edit fill-fields", "edit set-chart-data", "edit insert-number", "edit apply-endnote-shape", "edit insert-image", "edit redact", "edit sanitize", "run"]),
