...
LIVE = {
    ...
    "form-value": (["form-value", "samples/form-01.hwp", "--section", "0", "--para", "0", "--ctrl", "0", "--json"], "양식 개체 값 조회"),
    "header-footer": (["header-footer", DOC, "--json"], "구역 머리말/꼬리말 한 건 조회"),
...
FAMILIES = [
    ("10_조회", "조회 — 문서를 읽고 파악한다",
     ["info", "word-count", "bookmarks", "form-value", "header-footer", "explain", "digest", "search", "export-text", "export-structure", "fields", "dump-pages", "extract-pages"]),
