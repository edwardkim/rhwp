...
```bash
bash .agents/skills/rhwp-exam-ingest/helpers/pdf_to_pngs.sh <input.pdf> <out_dir>
bash .agents/skills/rhwp-exam-ingest/helpers/pdf_to_pngs.sh --json --dry-run <input.pdf> <out_dir>
```
...
```bash
python3 .agents/skills/rhwp-exam-ingest/helpers/extract_docx.py <input.docx> <out_dir>
```
...
```bash
bash .agents/skills/rhwp-exam-ingest/helpers/crop_image.sh \
...
```bash
bash .agents/skills/rhwp-exam-ingest/helpers/check_deps.sh --json
```
