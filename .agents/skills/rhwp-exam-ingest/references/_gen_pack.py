...
Run from repo root or this directory:
    ...
    python3 .agents/skills/rhwp-exam-ingest/references/_gen_pack.py
...
def example_body(fname, title, action, xref) -> str:
    ...
    if "pdf" in fname or "suneung" in fname or "poppler" in fname or "scan" in fname:
        lines += [
            "bash .agents/skills/rhwp-exam-ingest/helpers/pdf_to_pngs.sh \\",
    ...
    if "docx" in fname or "python_docx" in fname:
        lines += [
            "python3 .agents/skills/rhwp-exam-ingest/helpers/extract_docx.py \\",
