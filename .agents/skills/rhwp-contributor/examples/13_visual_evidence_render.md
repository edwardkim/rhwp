...
권위: [references/visual-evidence.md](../references/visual-evidence.md).
픽스처: [fixtures/envelopes/visual_required.json](../fixtures/envelopes/visual_required.json).
...
1. 렌더 변경이면 공개 샘플로 export-svg 전후를 남긴다.
2. 한컴 PDF 는 정답지가 아니다. 환경을 같이 적는다.
3. 스킬 문서만 만지면 시각 근거는 N/A 라고 본문에 적는다.
