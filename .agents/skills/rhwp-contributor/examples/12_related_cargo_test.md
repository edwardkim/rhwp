...
권위: [references/clippy-and-tests.md](../references/clippy-and-tests.md).
픽스처: [fixtures/envelopes/test_related_pass.json](../fixtures/envelopes/test_related_pass.json).
...
1. Rust: `cargo test --test agent_contributor_skill_contract`.
2. Python: `python -m unittest scripts.tests.test_agent_contributor`.
3. 본문에 실행한 시험 이름을 적는다.
...
- 작업 영수증이 필요하면 `.agents/skills/rhwp-work-receipt/` 를 읽고
