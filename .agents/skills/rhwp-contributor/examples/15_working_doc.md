...
권위: [references/working-doc.md](../references/working-doc.md).
픽스처: [fixtures/checklists/step_07_working.json](../fixtures/checklists/step_07_working.json).
...
1. 이슈 번호, 브랜치, 만진 경로, 시험, fmt 게이트를 적는다.
2. mydocs/pr/ 메인터너 기록은 만들지 않는다.
