...
EXAMPLES_SPEC = [
    ...
    (
        ...
        [
            "만질 경로: `.agents/skills/rhwp-contributor/`, working 문서, 계약 시험.",
    ...
    (
        ...
        [
            "git add -- .agents/skills/rhwp-contributor/SKILL.md",
    ...
    (
        ...
        [
            ...
            "`.agents/skills/rhwp-work-receipt/` 본문을 수정하지 않는다.",
    ...
    (
        ...
        [
            "git add -- .agents/skills/rhwp-contributor/",
            "git add -- mydocs/working/agent_contributor.md",
...
`.agents/skills/rhwp-contributor/` 를 레시피·예외·픽스처·계약 시험으로 고도화한다.
