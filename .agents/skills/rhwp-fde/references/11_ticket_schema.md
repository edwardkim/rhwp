# 11_ticket_schema — command/exit/signature/envelopeKeys.
...
```text
$ python3 tools/fde/triage.py case.hwpx --bin rhwp --symptom '11_ticket_schema.md' -o ticket.json
