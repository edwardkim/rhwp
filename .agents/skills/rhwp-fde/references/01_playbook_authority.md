# 01_playbook_authority — fde_playbook.md 가 표의 정본. 코드와 표는 같은 PR.
...
```text
$ python3 tools/fde/triage.py case.hwpx --bin rhwp --symptom '01_playbook_authority.md' -o ticket.json
