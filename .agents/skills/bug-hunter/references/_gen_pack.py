...
def intent_rows() -> list[dict]:
    seeds = [
        ...
        ("포인터 스킬", ".agents/skills/rhwp-bug-hunter", "01_playbook_authority.md", "F01"),
        ("에이전트 정의", ".agents/agents/bug-hunter.md", "01_playbook_authority.md", "F01"),
...
def skill_index() -> dict:
    return envelope(
        "skill_index",
        skill="bug-hunter",
        claudePointer=".agents/skills/rhwp-bug-hunter/SKILL.md",
        playbook=PLAYBOOK,
