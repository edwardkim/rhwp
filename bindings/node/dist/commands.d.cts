 ...
 */
import { Envelope, type BatchRecord } from './envelope.js';
import { type Argument } from './process.js';
/** 경로로 쓸 수 있는 값. */
...
export declare function info(path: PathLike, options?: CommandOptions): Promise<Envelope>;
/** {@link exportText} 옵션. */
 ...
 */
export declare function exportText(path: PathLike, options?: ExportTextOptions): Promise<Envelope>;
/** 구조 분류 방식. */
 ...
 * 무시된다(실측: 파일이 생기지 않는다).
 */
export declare function exportStructure(path: PathLike, options?: ExportStructureOptions): Promise<Envelope>;
/**
 ...
 */
export declare function exportTables(path: PathLike, options?: CommandOptions): Promise<Envelope>;
/** 누름틀(필드) 목록 — 이름·순번·현재값. */
export declare function fields(path: PathLike, options?: CommandOptions): Promise<Envelope>;
/** {@link search} 옵션. */
 ...
 * 옵션이 아닌 값으로 읽히게 한다.
 */
export declare function search(path: PathLike, query: string, options?: SearchOptions): Promise<Envelope>;
/** {@link digest} 옵션. */
...
export declare function digest(path: PathLike, options?: DigestOptions): Promise<Envelope>;
/** `explain`은 문서의 형식·쪽수·표·필드·각주를 한 번에 요약한다. */
export declare function explain(path: PathLike, options?: CommandOptions): Promise<Envelope>;
 ...
 * 읽으면 수기 목록을 둘 필요가 없다.
 */
export declare function capabilities(options?: CapabilitiesOptions): Promise<Envelope>;
 ...
 * 속성이 아니다.
 */
export declare function exportIrSchema(options?: IrSchemaOptions): Promise<Envelope>;
/** {@link exportPlanSchema} 옵션. */
export interface PlanSchemaOptions extends IrSchemaOptions, OutputOptions {
}
/** `run` 계획서 문법의 JSON Schema. */
export declare function exportPlanSchema(options?: PlanSchemaOptions): Promise<Envelope>;
...
export declare function exportAgentManifest(options?: AgentManifestOptions): Promise<Envelope>;
...
export declare function exportCapabilitiesSchema(options?: CapabilitiesSchemaOptions): Promise<Envelope>;
 ...
 */
export declare function exportOntology(options?: OntologyOptions): Promise<Envelope>;
export { csvToTable, exportProvenanceMap, extractData, inspect, tableToCsv, type CsvToTableOptions, type ExtractDataKind, type ExtractDataOptions, type InspectHiddenTextOptions, type InspectInjectionOptions, type InspectOptions, type InspectTarget, type InspectUnicodeOptions, type TableToCsvOptions, type UnicodeInspectionKind, } from './document-analysis.js';
...
/** SVG 렌더. */
export declare function exportSvg(path: PathLike, options?: ExportSvgOptions): Promise<Envelope>;
/** PDF backend. */
...
/** PDF 산출. */
export declare const exportPdf: (path: PathLike, options?: ExportPdfOptions | undefined) => Promise<Envelope>;
/** Markdown 산출. */
export declare const exportMarkdown: (path: PathLike, options?: PagedOutputOptions | undefined) => Promise<Envelope>;
/** HML 재직렬화. `out` 은 CLI 가 요구한다 — 원본 덮어쓰기를 막기 위해서다. */
export declare const exportHml: (path: PathLike, options?: OutputOptions | undefined) => Promise<Envelope>;
...
/** DocLang XML 산출. */
export declare const exportDoclang: (path: PathLike, options?: ExportDoclangOptions | undefined) => Promise<Envelope>;
/**
 * {@link thumbnail} 옵션.
 *
...
export declare const thumbnail: (path: PathLike, options?: ThumbnailOptions | undefined) => Promise<Envelope>;
/**
 * 쪽 범위를 잘라 새 문서로.
 *
 ...
 */
export declare function extractPages(path: PathLike, from: number, to: number, options?: OutputOptions): Promise<Envelope>;
...
export declare function buildFromIngest(spec: PathLike, options?: BuildFromIngestOptions): Promise<Envelope>;
/** {@link exportHwpx} 옵션. */
 ...
 */
export declare function exportHwpx(path: PathLike, options?: ConvertOptions): Promise<Envelope>;
/**
 ...
 */
export declare function convert(path: PathLike, options?: ConvertOptions): Promise<Envelope>;
/** {@link irDiff} 옵션. */
...
export declare function irDiff(a: PathLike, b: PathLike, options?: IrDiffOptions): Promise<Envelope>;
/** 라운드트립 경유 포맷. */
 ...
 */
export declare function renderDiff(path: PathLike, pathB?: PathLike | undefined, options?: RenderDiffOptions): Promise<Envelope>;
 ...
 */
export declare function verify(path: PathLike, options?: VerifyOptions): Promise<Envelope>;
/**
 * 누름틀 채우기 (메일머지).
 *
 * @param data - `{ "필드이름": "값" }`. 동명 필드는 `"이름#1"` 로 순번 지정.
 */
export declare function fillFields(path: PathLike, data: Readonly<Record<string, unknown>>, options?: EditOptions): Promise<Envelope>;
/** {@link replaceText} 옵션. */
...
export declare function replaceText(path: PathLike, find: string, replace: string, options?: ReplaceTextOptions): Promise<Envelope>;
/** {@link setCell} 옵션. */
 ...
 */
export declare function setCell(path: PathLike, table: number, row: number, col: number, text: string, options?: SetCellOptions): Promise<Envelope>;
/** {@link scan} 옵션. */
 ...
 */
export declare function scan(paths: PathLike | readonly PathLike[], options?: ScanOptions): Promise<Envelope>;
/** {@link batch} 옵션. */
 ...
 */
export declare function batch<T extends BatchRecord = BatchRecord>(subcommand: string, paths: readonly PathLike[], options?: BatchOptions): Promise<T[]>;
