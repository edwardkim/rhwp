...
//! 정상 원본에서 다시 생성한 HWPX의 한컴 2024 직접 PDF를 사용한다.
//!
//! 정본 규칙(`pdf/86712_regulatory_analysis-hwpx-2024.pdf` p33·p34 글리프 실측):
//! - p33의 10·32·18자 런은 약 0.496~0.513em, 25자 런은 약 0.573em.
//! - p34의 28·28·18자 런은 약 0.573em이며 끝점은 본문 여백 안에 있다.
//!
...
///
/// 종전 변형 입력에서는 마지막 줄 런들이 정확히
/// 0.300em(클램프 하한)이었다. 상한은 반대 방향의 회귀 — 슬랙 전량을 소수 dash 에
/// 쏟으면 짧은 런이 1.9em 까지 벌어진다(구현 중 실제로 만든 오답).
#[test]
