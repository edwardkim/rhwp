...
## `edit redact pii-demo.hwp --dry-run --no-raw --json`
...
## `edit redact pii-demo.hwp --dry-run --json   # 자동화 금지`
...
```json
{
  ...
  "exitCode": 0,
  "note": "레시피 3 실측 형태. 미끼 2건(900101-1234567, 1234-5678-9012-3456)은 없음.",
  "warning": "자동화 로그에 이 봉투를 붙이지 말 것. raw 키가 있다."
}
```

출처 픽스처: `fixtures/envelopes/redact_dry_run_with_raw.json`

## 다음

자동화는 noRaw true 이고 raw 키가 없는 봉투만 아티팩트.
