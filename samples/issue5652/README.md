...
B2-엔진 본구현에서 **엔진(`set_chart_data_by_index_native`, `structure:true`)이 만들어 한컴 2022 에
실제로 집어넣어 판정을 받은 32개 산출**이다. 받아 온 PDF 는 [`pdf/issue5652/`](../../pdf/issue5652/),
...
원장 ↔ 자산 32건의 SHA-256 과 등재 누락을 상시로 본다. 파일을 더하거나 빼면 그 테스트와 원장을
한 커밋에서 같이 옮긴다.
